...
# XXX_MIKE: apparently intended to guess passwords based on patterns
#           of characters related by physical proximity on a QWERTY
#           keyboard.  http://ob-security.info/files/keywalk-gen.pl
...
if (scalar(@ARGV) == 2) {
	if($ARGV[0] == 1){
		...
		# medium 4 character set, 76 elements, 20 char passwords - 76^4 = 33,362,176 combinations , 5 combinations - 76^5 = 2,535,525,376 combinations
